...
call pyside2-uic widget_environment.ui -o "..\src\DAVE\gui\forms\widgetUI_environment.py"
...
call pyside2-uic widget_ballastsolver.ui -o "..\src\DAVE\gui\forms\widgetUI_ballastsolver.py"
...
call pyside2-uic widget_area.ui -o "..\src\DAVE\gui\forms\widget_area.py"
...
call pyside2-uic widget_body.ui -o "..\src\DAVE\gui\forms\widget_body.py"
call pyside2-uic widget_poi.ui -o "..\src\DAVE\gui\forms\widget_poi.py"
call pyside2-uic widget_cable.ui -o "..\src\DAVE\gui\forms\widget_cable.py"
call pyside2-uic widget_connections.ui -o "..\src\DAVE\gui\forms\widget_connections.py"
call pyside2-uic addnode_form.ui -o "..\src\DAVE\gui\forms\addnode_form.py"
call pyside2-uic widget_name.ui -o "..\src\DAVE\gui\forms\widget_name.py"
...
call pyside2-uic widget_force.ui -o "..\src\DAVE\gui\forms\widget_force.py"
call pyside2-uic widget_sheave.ui -o "..\src\DAVE\gui\forms\widget_sheave.py"
call pyside2-uic widget_linhyd.ui -o "..\src\DAVE\gui\forms\widget_linhyd.py"
call pyside2-uic widget_lincon6.ui -o "..\src\DAVE\gui\forms\widget_lincon6.py"
...
call pyside2-uic widget_con2d.ui -o "..\src\DAVE\gui\forms\widget_con2d.py"
call pyside2-uic widget_spmt.ui -o "..\src\DAVE\gui\forms\widget_spmt.py"
call pyside2-uic frm_standard_assets.ui -o "..\src\DAVE\gui\forms\frm_standard_assets.py"
call pyside2-uic dlg_solver.ui -o "..\src\DAVE\gui\forms\dlg_solver.py"
call pyside2-uic dlg_settings.ui -o "..\src\DAVE\gui\forms\dlg_settingsr.py"
call pyside2-uic frm_animation.ui -o "..\src\DAVE\gui\forms\frm_animation.py"
call pyside2-uic widget_dynprop.ui -o "..\src\DAVE\gui\forms\widget_dynprop.py"
...
call pyside2-uic widget_sling.ui -o "..\src\DAVE\gui\forms\widget_sling.py"
call pyside2-uic widget_buoyancy.ui -o "..\src\DAVE\gui\forms\widget_buoyancy.py"
