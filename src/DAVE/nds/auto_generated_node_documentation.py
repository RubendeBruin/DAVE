...
info = NodePropertyInfo(node_class=cls,
                        property_name="color",
                        property_type=tuple,
                        doc_short="""The color (r,g,b) of the node - use None for default""",
                        doc_long = """The color (r,g,b) of the node - use None for default""",
                        units = """""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = False,
...
DAVE_NODEPROP_INFO[cls]["color"] = info
...
# ===================== Auto-generated documentation registration for Sling
cls = DAVE_ADDITIONAL_RUNTIME_MODULES["Sling"]
DAVE_NODEPROP_INFO[cls] = dict()

# Property: k_total
info = NodePropertyInfo(node_class=cls,
                        property_name="k_total",
                        property_type=float,
                        doc_short="""Total stiffness of the sling """,
                        doc_long = """Total stiffness of the sling [kN/m]""",
                        units = """[kN/m]""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = True,
...
DAVE_NODEPROP_INFO[cls]["k_total"] = info
...
info = NodePropertyInfo(node_class=cls,
                        ...
                        property_type=tuple,
                        doc_short="""List or Tuple of nodes (Points or Circles) that this sling is connected to. Nodes may be passed by name (string) or by reference.""",
                        doc_long = """List or Tuple of nodes (Points or Circles) that this sling is connected to. Nodes may be passed by name (string) or by reference.""",
                        units = """""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = False,
...
DAVE_NODEPROP_INFO[cls]["connections"] = info
...
info = NodePropertyInfo(node_class=cls,
                        property_name="reversed",
                        property_type=tuple,
                        doc_short="""The directions over which the sling runs over any intermediate connection circles""",
                        doc_long = """The directions over which the sling runs over any intermediate connection circles""",
                        units = """""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = False,
...
info = NodePropertyInfo(node_class=cls,
                        property_name="tension",
                        property_type=float,
                        doc_short="""Tension in (main part of) the sling """,
                        doc_long = """Tension in (main part of) the sling [kN]""",
                        units = """[kN]""",
                        remarks="""""",
                        is_settable=False,
                        is_single_settable = False,
...
info = NodePropertyInfo(node_class=cls,
                        property_name="length",
                        property_type=float,
                        doc_short="""Total length measured between the INSIDE of the eyes of the sling is pulled straight. """,
                        doc_long = """Total length measured between the INSIDE of the eyes of the sling is pulled straight. [m]""",
                        units = """[m]""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = True,
...
info = NodePropertyInfo(node_class=cls,
                        property_name="LeyeA",
                        property_type=float,
                        doc_short="""Total length inside eye A if stretched flat """,
                        doc_long = """Total length inside eye A if stretched flat [m]""",
                        units = """[m]""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = True,
...
DAVE_NODEPROP_INFO[cls]["LeyeA"] = info
...
info = NodePropertyInfo(node_class=cls,
                        property_name="LeyeB",
                        property_type=float,
                        doc_short="""Total length inside eye B if stretched flat """,
                        doc_long = """Total length inside eye B if stretched flat [m]""",
                        units = """[m]""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = True,
...
DAVE_NODEPROP_INFO[cls]["LeyeB"] = info


# Property: LspliceA
info = NodePropertyInfo(node_class=cls,
                        property_name="LspliceA",
                        property_type=float,
                        doc_short="""Length of the splice at end A """,
                        doc_long = """Length of the splice at end A [m]""",
                        units = """[m]""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = True,
...
DAVE_NODEPROP_INFO[cls]["LspliceA"] = info


# Property: LspliceB
info = NodePropertyInfo(node_class=cls,
                        property_name="LspliceB",
                        property_type=float,
                        doc_short="""Length of the splice at end B """,
                        doc_long = """Length of the splice at end B [m]""",
                        units = """[m]""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = True,
...
DAVE_NODEPROP_INFO[cls]["LspliceB"] = info
...
info = NodePropertyInfo(node_class=cls,
                        property_name="diameter",
                        property_type=float,
                        doc_short="""Diameter of the sling  """,
                        doc_long = """Diameter of the sling (except the splices) [m]""",
                        units = """[m]""",
                        remarks="""except the splices""",
                        is_settable=True,
                        is_single_settable = True,
                        is_single_numeric = True
                        )
...
info = NodePropertyInfo(node_class=cls,
                        property_name="EA",
                        property_type=float,
                        doc_short="""EA of the wire of the sling """,
                        doc_long = """EA of the wire of the sling [kN]
        See also: k_total""",
                        units = """[kN]""",
                        remarks="""""",
                        is_settable=True,
...
info = NodePropertyInfo(node_class=cls,
                        property_name="mass",
                        property_type=float,
                        doc_short="""Mass and weight of the sling. This mass is distributed over the two splices """,
                        doc_long = """Mass and weight of the sling. This mass is distributed over the two splices [mT]""",
                        units = """[mT]""",
                        remarks="""""",
                        is_settable=True,
                        is_single_settable = True,
