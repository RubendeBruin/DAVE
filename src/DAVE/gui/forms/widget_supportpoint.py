...
class Ui_SupportPointWidget(object):
    def setupUi(self, SupportPointWidget):
        ...
        self.label_16 = QLabel(SupportPointWidget)
        ...
        self.label_17 = QLabel(SupportPointWidget)
        ...
        self.gridLayout.addWidget(self.dsDeltaZ, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.dsKz, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.dsKx, 3, 1, 1, 1)

        self.dsKy = QDoubleSpinBox(self.widget_advanced)
        self.dsKy.setObjectName(u"dsKy")

        self.gridLayout.addWidget(self.dsKy, 4, 1, 1, 1)
    ...
    def retranslateUi(self, SupportPointWidget):
        ...
        self.label_16.setText(QCoreApplication.translate("SupportPointWidget", u"The reaction force starts when \"Point\" is lower than \"Z\" relative to \"Support\"", None))
