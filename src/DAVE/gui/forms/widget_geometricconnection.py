...
class Ui_GeometricConnection(object):
    def setupUi(self, GeometricConnection):
        ...
        GeometricConnection.resize(368, 675)
    ...
    def retranslateUi(self, GeometricConnection):
        ...
        self.rbPinHole.setText(QtWidgets.QApplication.translate("GeometricConnection", "Inside contact (Pin in Hole)", None, -1))
        self.rbPinPin.setText(QtWidgets.QApplication.translate("GeometricConnection", "Outside contact (Pin on pin)", None, -1))
        ...
        self.label.setText(QtWidgets.QApplication.translate("GeometricConnection", "Master rotation", None, -1))
        ...
        self.label_2.setText(QtWidgets.QApplication.translate("GeometricConnection", "Slave rotation", None, -1))
