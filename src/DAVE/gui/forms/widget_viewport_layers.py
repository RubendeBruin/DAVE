...
from PySide6.QtWidgets import (QApplication, QFontComboBox, QGridLayout, QLabel,
...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.cbFont = QFontComboBox(Widget)
        self.cbFont.setObjectName(u"cbFont")

        self.gridLayout.addWidget(self.cbFont, 4, 1, 1, 4)
        ...
        QWidget.setTabOrder(self.layerList, self.cbFont)
        QWidget.setTabOrder(self.cbFont, self.sbBorderWidth)
    ...
    def retranslateUi(self, Widget):
        ...
        self.pbBackgroundColor.setText(QCoreApplication.translate("Widget", u"PushButton", None))
        ...
        self.label_8.setText(QCoreApplication.translate("Widget", u"Font face", None))
        self.pbBorderColor.setText(QCoreApplication.translate("Widget", u"PushButton", None))
