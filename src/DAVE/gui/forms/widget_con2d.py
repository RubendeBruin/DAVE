...
class Ui_widget_con2d(object):
    ...
    def retranslateUi(self, widget_con2d):
        ...
        self.label.setText(QtWidgets.QApplication.translate("widget_con2d", "2d-connector works on shortest distance and angle between two Frames or Bodies", None, -1))
