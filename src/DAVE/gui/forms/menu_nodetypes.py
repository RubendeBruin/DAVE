...
class Ui_MenuNodes(object):
    ...
    def retranslateUi(self, MenuNodes):
        ...
        self.label_7.setText(QCoreApplication.translate("MenuNodes", u"Non-physical", None))
        self.pbVisual.setText(QCoreApplication.translate("MenuNodes", u"Visual", None))
        self.pbMeasurement.setText(QCoreApplication.translate("MenuNodes", u"Measurement", None))
    # retranslateUi
