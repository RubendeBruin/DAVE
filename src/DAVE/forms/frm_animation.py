...
#
# Created: Wed Nov 27 19:57:44 2019
...
class Ui_AnimationWindow(object):
    ...
    def retranslateUi(self, AnimationWindow):
        ...
        self.tableWidget.horizontalHeaderItem(1).setText(QtWidgets.QApplication.translate("AnimationWindow", "Node", None, -1))
        self.tableWidget.horizontalHeaderItem(2).setText(QtWidgets.QApplication.translate("AnimationWindow", "Mode", None, -1))
        self.tableWidget.horizontalHeaderItem(3).setText(QtWidgets.QApplication.translate("AnimationWindow", "Inertia", None, -1))
        self.tableWidget.horizontalHeaderItem(4).setText(QtWidgets.QApplication.translate("AnimationWindow", "Radius", None, -1))
        self.tableWidget.horizontalHeaderItem(5).setText(QtWidgets.QApplication.translate("AnimationWindow", "(children)", None, -1))
        self.tableWidget.horizontalHeaderItem(6).setText(QtWidgets.QApplication.translate("AnimationWindow", "Stiffness", None, -1))
        self.tableWidget.horizontalHeaderItem(7).setText(QtWidgets.QApplication.translate("AnimationWindow", "unconstrained", None, -1))
        self.tableWidget.horizontalHeaderItem(8).setText(QtWidgets.QApplication.translate("AnimationWindow", "no-inertia", None, -1))
        self.pushButton_2.setText(QtWidgets.QApplication.translate("AnimationWindow", "PushButton", None, -1))
