...
import virtualfloat.widget_axis
import virtualfloat.widget_body
import virtualfloat.widget_poi
import virtualfloat.widget_cable
import virtualfloat.widget_name
import virtualfloat.widget_visual
import virtualfloat.widget_force
import virtualfloat.widget_lincon6
import virtualfloat.widget_linhyd
import virtualfloat.widget_beam
import virtualfloat.widget_con2d

import virtualfloat.addnode_form

import virtualfloat.scene as vfs
...
class EditNode(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditNode._ui is None:
            ...
            ui = virtualfloat.widget_name.Ui_NameWidget()
            ui.setupUi(widget)
            EditNode._ui = ui
            ui._widget = widget
...
class EditAxis(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditAxis._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_axis.Ui_widget_axis()
            ui.setupUi(widget)
            EditAxis._ui = ui
            ui._widget = widget
...
class EditVisual(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditVisual._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_visual.Ui_widget_axis()
            ui.setupUi(widget)
            EditVisual._ui = ui
            ui._widget = widget
...
class EditBuoyancy(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditBuoyancy._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_visual.Ui_widget_axis() # same as visual widget!
            ui.setupUi(widget)
            EditBuoyancy._ui = ui
            ui._widget = widget
...
class EditBody(EditAxis):
    ...
    def create_widget(self):
        ...
        if EditBody._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_body.Ui_Form()
            ui.setupUi(widget)
            EditBody._ui = ui
            ui._widget = widget
...
class EditPoi(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditPoi._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_poi.Ui_Poi()
            ui.setupUi(widget)
            EditPoi._ui = ui
            ui._widget = widget
...
class EditCable(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditCable._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_cable.Ui_Cable_form()
            ui.setupUi(widget)
...
class EditForce(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditForce._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_force.Ui_widget_force()
            ui.setupUi(widget)
            EditForce._ui = ui
            ui._widget = widget
...
class EditHydSpring(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditHydSpring._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_linhyd.Ui_widget_linhyd()
            ui.setupUi(widget)
...
class EditLC6d(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditLC6d._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_lincon6.Ui_widget_lincon6()
            ui.setupUi(widget)
            EditLC6d._ui = ui
            ui._widget = widget
...
class EditConnector2d(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditConnector2d._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_con2d.Ui_widget_con2d()
            ui.setupUi(widget)
...
class EditBeam(NodeEditor):
    ...
    def create_widget(self):
        ...
        if EditBeam._ui is None:
            ...
            widget = QtWidgets.QWidget()
            ui = virtualfloat.widget_beam.Ui_widget_beam()
            ui.setupUi(widget)
            EditBeam._ui = ui
            ui._widget = widget
...
def add_node(scene):
    ...
    ui = virtualfloat.addnode_form.Ui_Dialog()
    ui.setupUi(AddNode)
