...
import virtualfloat.visual as vfv
import virtualfloat.scene as vfs
import virtualfloat.constants as vfc

import virtualfloat.viewer_form

import numpy as np
import math

import virtualfloat.element_widgets as element_widgets
...
class Gui:
    ...
    def __init__(self, scene):
        ...
        self.ui = virtualfloat.viewer_form.Ui_MainWindow()
        """Reference to the ui"""
    ...
    def goal_seek_go(self):
        ...
        code = 's.goal_seek(set_property="{}",\nset_node="{}",\ntarget={},\nchange_property="{}",\nchange_node="{}")'.format(self.ui.gsSetProp.text(),
    ...
    def new_axis(self):
        self.new_something(virtualfloat.element_widgets.add_axis)

    def new_body(self):
        self.new_something(virtualfloat.element_widgets.add_body)

    def new_poi(self):
        self.new_something(virtualfloat.element_widgets.add_poi)

    def new_cable(self):
        self.new_something(virtualfloat.element_widgets.add_cable)

    def new_force(self):
        self.new_something(virtualfloat.element_widgets.add_force)

    def new_linear_connector(self):
        self.new_something(virtualfloat.element_widgets.add_linear_connector)

    def new_connector2d(self):
        self.new_something(virtualfloat.element_widgets.add_connector2d)

    def new_beam(self):
        self.new_something(virtualfloat.element_widgets.add_beam_connector)

    def new_linear_hydrostatics(self):
        self.new_something(virtualfloat.element_widgets.add_linear_hydrostatics)

    def new_visual(self):
        self.new_something(virtualfloat.element_widgets.add_visual)

    def new_buoyancy_mesh(self):
        self.new_something(virtualfloat.element_widgets.add_buoyancy)
